            ...
            this.appContainer.innerHTML = `
                <div id="flashcard-container" class="max-w-2xl mx-auto">
                    ...
                    <div class="flex justify-between mt-4">
                     ...
                     <button id="back-to-menu-flashcard-btn" class="w-full mt-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-5 rounded-lg shadow-md transition duration-200 ease-in-out" onclick="this.game.renderMenu()">${this.MESSAGES.get('backToMenu')}</button>
                </div>
            `;
