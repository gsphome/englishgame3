export const MESSAGES = {
    ...
    es: {
        ...
        // Settings
        settingDescriptionColumn: "Descripción",
        settingExplanationTitle: "Explicación de Ajustes",
        settingNameColumn: "Ajuste",
        settingValueColumn: "Valor Actual",
        settingsDefaultLanguage: "Idioma Predeterminado",
        settingsLearning: "Ajustes de Aprendizaje",
        settingsGeneral: "Ajustes Generales",
        settingsHelpButton: "Ayuda",
        settingsFlashcardModeWordCount: "Flashcards: #Tarjetas",
        settingsMatchingModeWordCount: "Matching: #Palabras",
        settingsQuizModeQuestionCount: "Quiz: #Preguntas",
        settingsSortingModeWordCount: "Sorting: #Elementos",
        settingsCompletionModeItemCount: "Completation: #Elementos",
    ...
    en: {
        ...
        settingExplanationTitle: "Settings Explanation",
        settingNameColumn: "Setting",
        settingValueColumn: "Current Value",
        settingsCompletionModeItemCount: "Completation: #Elements",
        settingsDefaultLanguage: "Default Language",
        settingsLearning: "Learning Settings",
        settingsGeneral: "General Settings",
        settingsHelpButton: "Help",
        settingsFlashcardModeWordCount: "Flashcards: #Cards",
        settingsMatchingModeWordCount: "Matching: #Words",
        settingsQuizModeQuestionCount: "Quiz: #Questions",
        settingsSortingModeWordCount: "Sorting: #Items",
